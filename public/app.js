      ...
      <div class="groups-list">
        ${groups.map(group => `
          <div class="group-card">
            <button
              onclick="deleteGroupPrompt(${Number(group.id)})"
              class="danger group-card-delete"
            ...
            <div class="group-card-actions">
              ...
              <button onclick="playGroup(${Number(group.id)})" class="secondary group-card-play">Play</button>
            </div>
          </div>
        `).join('')}
      </div>
